export const uz = {
  ...
  students: {
    ...
    delete: "O'chirish",
    deleteSuccess: "O'quvchi muvaffaqiyatli o'chirildi",
    cancel: "Bekor qilish",
    ...
    noStudentsDescription: "Hozircha o'quvchilar ro'yxati bo'sh",
    deleteConfirmDescription: "Siz rostdan ham {name} o'quvchisini o'chirmoqchimisiz? Bu amalni qaytarib bo'lmaydi.",
    totalTests: "Umumiy testlar",
